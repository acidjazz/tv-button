...
// CONCATENATED MODULE: ./src/PushButton.vue?vue&type=template&id=7a6cc1ac&
...
/* harmony default export */ var PushButtonvue_type_script_lang_js_ = ({
  ...
  data () {
    return {
      ...
      loading: {
        white: 'bg-gray-200 cursor-wait',
        indigo: 'bg-white bg-indigo-400 cursor-wait',
        'indigo-light': 'bg-indigo-300 cursor-wait',
        red: 'bg-red-400 cursor-wait',
      },
    }
  },
  computed: {
