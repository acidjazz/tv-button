...
// CONCATENATED MODULE: ./src/PushButton.vue?vue&type=template&id=2a4eb9bf&
  ...
  data () {
    return {
      ...
      active: {
        ...
        'indigo-dark': 'hover:bg-indigo-600 focus:outline-none focus:border-indigo-500 focus:shadow-outline-indigo active:bg-indigo-600',
